...
const NavMenuMobile = () => {
  return (
    <>
      <ul tabIndex={0} className="nav-mobile menu menu-sm dropdown-content bg-base-100 gap-1 rounded-box z-[1] mt-3 w-52 p-2 border border-2 border-base-300 shadow">
        {menuItems.map((item) => {

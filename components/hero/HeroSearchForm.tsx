...
const HeroSearchForm = () => {
  return (
    <form action="/rent" className="heroInputForm form-control shadow-lg p-1 rounded-xl sm:rounded-full overflow-hidden sm:w-full border border-neutral-content">
      <div className="heroInputFormContainer input-group flex flex-col sm:flex-row">
        ...
        <button className="btn  mbtn-primary sm:btn-circle"> <MdSearch className='w-5 h-5'/> </button>
      </div>
    </form>
  )
}
